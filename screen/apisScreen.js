...
import { View, Dimensions, Text, StatusBar, Linking, ScrollView } from 'react-native';
...
const DATA = [
    ...
    {
        title: 'react-native-firebase/admob',
        type: 'Apache-2.0 License',
        description: 'Copyright (c) 2016-present Invertase Limited <oss@invertase.io> & Contributors',
        link: 'https://github.com/invertase/react-native-firebase/tree/master/packages/admob'
    },
    {
        title: 'react-native-firebase/app',
        type: 'Apache-2.0 License',
        description: 'Copyright (c) 2016-present Invertase Limited <oss@invertase.io>',
        link: 'https://github.com/invertase/react-native-firebase/tree/master/packages/app'
    },


]
export default apisScreen = (props) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: RED }}>
            ...
            >
                ...
                {DATA.map((data, index) => <BaseButton key={index} onPress={() => Linking.openURL(data.link)} rippleColor='#bbb' style={{ width: '100%', paddingHorizontal: 20, paddingVertical: 10 }}>
                    {/* <View style={{ width: 50, alignItems: 'center' }}>
                        <Icon name="cloud" size={20} color='white' />
                    </View> */}
                    <Text style={{ fontSize: 20, color: 'white' }}>{data.title}</Text>
                    <Text style={{ fontSize: 14, color: 'white' }}>{data.description}</Text>
