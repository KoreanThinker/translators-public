...
import { View, Dimensions, Text, StatusBar, AsyncStorage, FlatList } from 'react-native';
...
export default fullScreen = (props) => {
    ...
    const [oldData, setOldData] = useState(navigation.getParam('oldData', []))
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <FlatList
                ...
                ListHeaderComponent={<View style={{ backgroundColor: RED, width: '100%', height: 52, flexDirection: 'row', marginBottom: 20 }}>
                    <View style={{ width: 52, height: 52, alignItems: 'center', justifyContent: 'center' }}>
                        <TouchableWithoutFeedback onPress={() => navigation.goBack()}>
                            <Icon name="arrow-back" size={24} color='white' style={{ margin: 5 }} />
                ...
                data={oldData}
                renderItem={({ item, index }) => <OldTranslatedCard
                    text={item.text}
